        ...
        <el-container>
            ...
            <el-container>
                ...
                <el-aside width="220px">
                    <el-row class="tac">
                        <el-col :span="12">
                            <el-menu default-active="3-4" class="el-menu-vertical-demo" @open="handleOpen" @close="handleClose" :collapse="isCollapse">
                ...
                <el-container>
                    ...
                    <div style="height: 30px;">
                        ...
                        <el-pagination background layout="prev, pager, next" :total=adminlength>
                        </el-pagination>
    ...
    <script>
        var app = new Vue({
            ...
            methods: {
                // 获取用户
                getadmin: function() {
                    this.$http.post('../getadmin.php').then(response => {
                        var adminObj = eval("(" + response.bodyText + ")");
                        this.admin = adminObj
                        this.adminlength = adminObj.length
                    }, function() {
