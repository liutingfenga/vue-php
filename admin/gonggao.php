        ...
        <el-container>
            ...
            <el-container>
                ...
                <el-aside width="220px">
                    <el-row class="tac">
                        <el-col :span="12">
                            <el-menu default-active="3-2" class="el-menu-vertical-demo" @open="handleOpen" @close="handleClose" :collapse="isCollapse">
                ...
                <el-container>
                    ...
                    <div style="height: 30px;">
                        ...
                        <!-- 商品表格 -->
                        <el-table :data="gonggaos" border style="width: 100%">
                            ...
                            <el-table-column prop="time" label="事件" width="120">
                            </el-table-column>
                        ...
                        <el-pagination background layout="prev, pager, next" :total=gonggaoslength>
                        </el-pagination>
        ...
        var app = new Vue({
            ...
            getgonggao: function() {
                this.$http.post('../getgonggao.php').then(response => {
                    ...
                    this.gonggaoslength = gonggaoObj.length
